...
ventana.geometry("455x640+30+30") #Dimensiones de la ventana | 30+30 indica las coordenadas X Y donde aparece la ventana
ventana.iconbitmap("arco_logo.ico") #Imagen icono de la ventana
